...
namespace Yelp.Model.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Workspaces\DotnetProjects\ML_Projects\SentimentAnalysisDemos\SentimentAnalysisFromCLI\YelpSentimentProgram\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"../../../../Yelp.Model.Model/MLModel.zip";
